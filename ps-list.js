...
function parse(text) {
  ...
  var ps = lines.map(function (line) { //this could parse alot of unix command output
...
module.exports = function childrenOfPid(callback) {
  var headers = null;
  ...
  if (process.platform === 'win32') {
    ...
    exec('ps -A -o ppid,pid,stat,comm', handler);
  }
}
